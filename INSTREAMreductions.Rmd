...
```
Positive relative reduction values represent an increase over historical observations. Alternative specifies $H_a$: current observations are ___ than historical observations